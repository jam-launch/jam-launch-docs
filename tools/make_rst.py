...
# Copied from https://github.com/godotengine/godot/blob/1c8ae43efefa679ed01ddefb38ccf2c1e52abb22/doc/tools/make_rst.py
...
# not currently relevant for docs
version = {}
...
def make_rst_class(class_def: ClassDef, state: State, dry_run: bool, output_dir: str) -> None:
    ...
    if dry_run:
        ...
        f = open(os.path.join(output_dir, "class_" + class_name.lower().strip('"').replace('/', '_') + ".rst"), "w", encoding="utf-8")
